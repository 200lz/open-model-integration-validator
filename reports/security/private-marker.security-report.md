...
- Report: `security_report_051e1d5a972c2220cd3990627234bf0a`
...
- Bytes declared/discovered/inspected/not inspected: 56/56/56/0
...
- `private-marker.txt`: Built-in scanner has no structure parser for this file type.
