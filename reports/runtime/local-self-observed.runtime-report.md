...
- Observation strength: **SYSTEM_OBSERVED**
- Source security verdict: **PASS**
- Required dimensions observed: **5/5**
- Proxy-only dimensions: `None`
- Unobserved dimensions: `None`
- Approved artifact set: `deployment_artifact_set_cd68f234c89aca95a9edbd9cef3391cd`
- Artifact-set continuity: **FULL_CONTINUITY**
...
- Policy-scoped verdict: **PASS_WITH_LIMITATIONS**
- Snapshot only: **YES**
...
- Deployment was self-observed; independent corroboration is absent.
