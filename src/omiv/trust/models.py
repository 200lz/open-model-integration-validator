...
class SignedObjectType(StrEnum):
    ...
    TOKENIZER_CONFIGURATION_EXPECTATION = "TOKENIZER_CONFIGURATION_EXPECTATION"
    TOKENIZER_ASSET_OBSERVATION = "TOKENIZER_ASSET_OBSERVATION"
    TOKENIZER_CONFIGURATION_PARITY_EVIDENCE = "TOKENIZER_CONFIGURATION_PARITY_EVIDENCE"
    REGISTRY_RESOLUTION_RECEIPT = "REGISTRY_RESOLUTION_RECEIPT"
    MODEL_RUNTIME_BINDING = "MODEL_RUNTIME_BINDING"
    RUNTIME_RESOLUTION_PARITY_EVIDENCE = "RUNTIME_RESOLUTION_PARITY_EVIDENCE"
...
class SignaturePurpose(StrEnum):
    ...
    TOKENIZER_CONFIGURATION_EXPECTATION_ISSUANCE = "TOKENIZER_CONFIGURATION_EXPECTATION_ISSUANCE"
    TOKENIZER_ASSET_OBSERVATION_ISSUANCE = "TOKENIZER_ASSET_OBSERVATION_ISSUANCE"
    TOKENIZER_CONFIGURATION_PARITY_EVIDENCE_ISSUANCE = (
        "TOKENIZER_CONFIGURATION_PARITY_EVIDENCE_ISSUANCE"
    )
    REGISTRY_RESOLUTION_RECEIPT_ISSUANCE = "REGISTRY_RESOLUTION_RECEIPT_ISSUANCE"
    MODEL_RUNTIME_BINDING_ISSUANCE = "MODEL_RUNTIME_BINDING_ISSUANCE"
    RUNTIME_RESOLUTION_PARITY_EVIDENCE_ISSUANCE = "RUNTIME_RESOLUTION_PARITY_EVIDENCE_ISSUANCE"
