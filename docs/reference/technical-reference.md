# OMIV technical reference

> **Historical-reference notice:** This document preserves the historical README and
> detailed technical material. It is not the authoritative current project-status
> page. Historical “future phase” or “reserved” wording records the state when that
> section was written and may describe work that was implemented later. The current
> [main README](../../README.md), [roadmap](../roadmap.md), and maintained current phase
> documents govern current status.
...
repository. See the [security policy](../../SECURITY.md),
[contribution guide](../../CONTRIBUTING.md), [support policy](../../SUPPORT.md),
[governance](../../GOVERNANCE.md),
[public/commercial boundary](../public-commercial-boundary.md), and
